...
class CustomerRatingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loadingDialog = LoadingDialog(this@CustomerRatingActivity)
        ...
        APIService().doGet<PreRatingResponse>("bookings/$bookingId/rating/pre-rating-info", object :
            ...
            override fun onSuccess(data: Any) {
                ...
                ratingBtn.setOnClickListener {
                    ...
                    APIService().doPost<Any>("bookings/$bookingId/customer-rating", ratingRequest, object :
                        APICallback<Any> {
                        override fun onSuccess(data: Any) {
                            Log.i("Notification", "result: $data")
                            Toast.makeText(this@CustomerRatingActivity, "Đánh giá thành công", Toast.LENGTH_SHORT).show()
                        ...
                        override fun onError(error: Throwable) {
                            ...
                            Toast.makeText(this@CustomerRatingActivity, "Đánh giá thất bại", Toast.LENGTH_SHORT).show()
                            loadingDialog.dismissDialog()
                        }
                    })
                }
